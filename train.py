...
import time
import json
import numpy as np  # <-- necesario para guardar y cargar preds
import torch
...
class Trainer:
    ...
    def train(self):
        ...
        for epoch in range(self.config['epochs']):
            ...
            # Validar cada 3 épocas (y en la última)
    ...
    def evaluate(self):
        ...
        # Matriz de confusión para el informe
        self._plot_confusion_matrix(all_targets, all_predictions)

        # Guardado para figuras y tablas
        os.makedirs("results", exist_ok=True)
        np.savez(
            "results/preds_test.npz",
    ...
    def plot_history(self):
        ...
        # Algunas entradas de val pueden ser None (validación cada 3 épocas)
